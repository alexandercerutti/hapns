 ...
 *
 * @warning
 * This example has not been tested as there is no iOS example application
 * to support it. If it works, a confirmation issue would be appreciated.
 */
...
const notification = LocationNotification(APNS_TOPIC, {
	priority: 10,
	expiration: 0,
});
